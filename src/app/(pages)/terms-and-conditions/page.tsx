export const metadata = {
  title: "Terms & Conditions | Thrive From Thorns",
  description:
    "Terms and conditions for using the Thrive From Thorns website.",
  alternates: { canonical: "/terms-and-conditions" },
  openGraph: {
    title: "Terms & Conditions | TFT",
    description:
      "Terms and conditions for using the Thrive From Thorns website.",
      ...
      <div className="max-w-5xl mx-auto">
        <header className="text-center mb-16 animate-fade-in">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Terms <span className="text-TWT-primary">&amp; Conditions</span>
          </h1>
        ...
        <div className="prose prose-gray max-w-none prose-headings:font-bold prose-headings:text-gray-900 prose-p:leading-relaxed prose-li:leading-relaxed">
          <h2 className="text-xl font-semibold mt-8 mb-4">
            Welcome to Thrive From Thorns (TFT)
          </h2>
          <p>
            Thrive From Thorns stands as a non-profit non-governmental
            organization with a mission to uplift the education of
            underprivileged children in Kenya. Our core dedication lies in
          ...
          <p>
            ...
            use of Thrive From Thorns&apos;s Website, located at
            {process.env.NEXT_PUBLIC_BASE_URL || "https://thrivewiththorns.org"}.
          </p>
          <p>
            By accessing this website, we assume you accept these terms and
            conditions. Do not continue to use Thrive From Thorns if you
          ...
          <p>
            We employ the use of cookies. By accessing Thrive From Thorns,
            you agreed to use cookies in agreement with the Thrive From Thorns&apos;s Privacy Policy. Most interactive websites use cookies
          ...
          <p>
            Unless otherwise stated, Thrive From Thorns and/or its
            licensors own the intellectual property rights for all material on
            Thrive From Thorns Site. All intellectual property rights are
            reserved. You may access this from Thrive From Thorns for your
            own personal use subjected to restrictions set in these terms and
            conditions.
          </p>
          <p>You must not:</p>
          <ul className="list-disc pl-6 mt-2">
            <li>Republish material from Thrive From Thorns</li>
            <li>
              Sell, rent or sub-license material from Thrive From Thorns
            </li>
            <li>
              Reproduce, duplicate or copy material from Thrive From Thorns
              Kenya
            </li>
            <li>Redistribute content from Thrive From Thorns</li>
          </ul>
          <p className="mt-6">
            Parts of this website offer an opportunity for users to post and
            exchange opinions and information in certain areas of the website.
            Thrive From Thorns does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of Thrive From Thorns, its
            ...
            permitted by applicable laws, Thrive From Thorns shall not be
          ...
          <p>
            Thrive From Thorns reserves the right to monitor all Comments
          ...
          <p className="mt-6">
            You hereby grant Thrive From Thorns a non-exclusive license to
          ...
          <p className="mt-6">
            ...
            Survival Aid Kenya; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to Thrive From Thorns. Please include your
          ...
          <p className="mt-6">
            No use of Thrive From Thorns&apos;s logo or other artwork will
          ...
          <p>
            ...
            <br /> P. O. Box TN 0000, Eldo Estate
            <br />
            E-mail:{" "}
            <a
              href="mailto:thrivewfromthorns@gmail.com"
              className="text-TWT-primary hover:underline"
            >
              thrivewfromthorns@gmail.com
            </a>
            <br />
            Tel: +254 00 000 0000
          </p>
