export const TEAM_MEMBERS = [
...

  {
    ...
    testimonial:
      "Moses Omondi Sadia is a seasoned clinician, epidemiologist, and public health leader with over 13 years of experience advancing health systems, community health, and implementation science across Kenya. His work spans grassroots health programming, national policy implementation, academic teaching, and applied public health research.\n\nMoses has led USAID-funded malaria and integrated disease surveillance projects across multiple counties, managing complex teams and budgets exceeding $1 million. He previously led large-scale community health initiatives at Lwala Community Alliance, impacting over 1.2 million people and spearheading the rollout of Kenya's Electronic Community Health Information System (eCHIS)—a flagship digital health reform under the Ministry of Health.\n\nMoses holds a Master of Science in Epidemiology and Biostatistics, a Bachelor of Science in Public Health, and a Diploma in Clinical Medicine & Surgery. He is currently pursuing a Ph.D. in Public Health. He has served as Principal Investigator and Co-Principal Investigator on multi-county operational and implementation research studies, including therapeutic efficacy studies for malaria, severe malaria case reviews, and health systems evaluations.\n\nHis scholarly contributions include publications in peer-reviewed journals covering vaccine hesitancy, child nutrition, immunization, and malaria interventions. As a part-time lecturer at several Kenyan universities, he contributes to building public health capacity through teaching and mentorship.\n\nMoses has worked with a wide range of development partners—including USAID, PMI, Jhpiego, KEMRI, and Harvard University—offering technical leadership in maternal and child health, epidemiology, community systems strengthening, and monitoring and evaluation.\n\nAs a Board Member at Thrive for Thorns, Moses brings deep technical expertise, strategic insight, and a strong commitment to evidence-based health interventions that drive sustainable, inclusive development at both community and systems levels.",
  },
];
...
export const VOLUNTEER_TESTIMONIALS = [
  {
    ...
    testimonial: "Volunteering as a mentor with Thrive From Thorns Kenya has been life-changing—not just for the youth I work with, but for me as well. I started mentoring a group of teenagers who were struggling with self-confidence and decision-making, guiding them through life skills workshops, career planning, and personal development sessions.\n\nOne young boy, Joseph, had dropped out of school because he felt he had no future. Over months of mentorship, I watched him rediscover his self-worth, set goals, and even take on leadership roles in his community. The moment he shared with me that he now dreams of becoming a teacher himself—it brought tears to my eyes. Mentorship is about planting seeds of hope, nurturing them with care, and witnessing lives bloom. TFT doesn't just teach skills; it transforms mindsets and inspires young people to step boldly into their future.",
  },
  {
    id: "v2",
    name: "Duncan Okuro",
    designation: "Economist and Livelihood expert",
    role: "Economic Empowerment for Families",
    imageUrl: "/images/volunteers/duncan-okuro.jpg",
    testimonial: "Being part of TFT's economic empowerment programs for families opened my eyes to the power of opportunity. I worked with parents and guardians, helping them learn skills in entrepreneurship, vocational training, and sustainable income generation.\n\nOne family I worked with had struggled for years to make ends meet. Through training and mentorship, they started a small poultry business, learned financial planning, and began earning enough to support their children's education. Seeing their pride and independence grow was unforgettable. TFT taught me that empowering families economically doesn't just alleviate poverty—it restores dignity, strengthens homes, and creates a ripple effect that uplifts entire communities.",
  },
  {
    id: "v3",
    name: "Sharon Omondi",
    designation: "Finance expert",
    role: "Sponsorship & Education Support",
    imageUrl: "/images/volunteers/sharon-omondi.jpg",
    testimonial: "I joined TFT to support the sponsorship program, helping children gain access to education and essential resources. I met Grace, a bright 10-year-old girl who had the potential to excel but lacked school fees and learning materials. Through TFT's sponsorship program, she received full educational support, mentorship, and guidance.\n\nMonths later, she had not only caught up academically but had become a leader among her peers, mentoring younger students herself. Witnessing the transformative power of sponsorship reinforced why TFT's model works—it's about providing more than funds; it's about giving hope, stability, and the tools for lifelong success. Every child supported becomes a story of resilience and possibility.",
  }
];
